...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		ARM64_DIR=$KERNEL_DIR/arm64
		ARM_DIR=$KERNEL_DIR/arm
	fi

	msg "|| Cloning Anykernel ||"
	git clone --depth 1 --no-single-branch https://github.com/NetErnels/AnyKernel3.git -b a70q
	msg "|| Cloning libufdt ||"
...
exports() {
	...
	then
		...
		PATH=$TC_DIR/bin/:$ARM64_DIR/bin:$ARM_DIR/bin:$PATH
	elif [ $COMPILER = "gcc" ]
	then
